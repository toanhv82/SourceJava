 ...
 * @author toanhv1
 */
public class UpdateRelationCardXML extends XmlToString{
    private String fileName="xml/Update_Contract_relaticard.xml";
    private String xmlString;
    private final String orderDprt="0168";
    public  UpdateRelationCardXML() throws Exception
    {
    ...
    {                      
         String   xml=xmlString;
                xml= xml.replace(DEF_XML.ContractNumber, cardContract.getCardContractNumber())
                    ...
                    .replace(DEF_XML.AddressLine1, cardContract.getAddressLine1())
                     .replace(DEF_XML.PhoneNumber, cardContract.getPhoneNumber())                        
