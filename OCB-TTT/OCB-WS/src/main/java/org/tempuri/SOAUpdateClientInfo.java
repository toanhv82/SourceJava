 ...
 *         &lt;element name="in_CIF" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "SOA_Update_Client_Info")
public class SOAUpdateClientInfo {

    @XmlElement(name = "source_chanel")
    protected String sourceChanel;
    @XmlElement(name = "in_CIF")
    protected String inCIF;
    ...
    /**
     * Gets the value of the inCIF property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getInCIF() {
        return inCIF;
    }

    /**
     * Sets the value of the inCIF property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInCIF(String value) {
        this.inCIF = value;
    }
