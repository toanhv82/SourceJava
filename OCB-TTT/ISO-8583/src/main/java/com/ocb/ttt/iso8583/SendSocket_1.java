...
public class SendSocket_1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            SendSocket_1 sendSocket = new SendSocket_1();       
    ...
    private ISOMsg setData() throws ISOException {
       ...
       isoMsg.set(3, "002000");
       isoMsg.set(4, "000000129800");
       isoMsg.set(6, "003008115000");
       isoMsg.set(7, "11081834");
       isoMsg.set(12, "183217");
       isoMsg.set(11, "926772");
       isoMsg.set(13, "0218");
       isoMsg.set(18, "6011"); //for ATM
      // isoMsg.set(18, "5968"); //for POST
       isoMsg.set(28, "10000000");
       isoMsg.set(29, "00000000");
       isoMsg.set(30, "00000000");
       isoMsg.set(31, "00000000");
      ...
      // isoMsg.set(60, "MAST");
       ...
       //isoMsg.set(102, "0031100013461007");
