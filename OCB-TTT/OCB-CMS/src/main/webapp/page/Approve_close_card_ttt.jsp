...
<body>
    ...
    <div class="container">
        ...
        <div style="display: inline-block;">
            <button hidden="true" type="button" class="btn btn-primary" id="active">
                <span class="glyphicon glyphicon-adjust" ></span> Kích hoạt thẻ
            </button>
        </div>
        <div style="display: inline-block;">
            <button type="button" class="btn btn-primary" id="return">
                <span class="glyphicon glyphicon-adjust" ></span> Khóa tạm thời
            </button>
        </div>       
        <div style="display: inline-block;">
            <button type="button" class="btn btn-primary" id="close_card">
                <span class="glyphicon glyphicon-adjust" ></span> Khóa vĩnh viễn
            </button>
        </div>
        <div style="display: inline-block;">
            <button type="button" class="btn btn-primary" id="close_account_number">
                <span class="glyphicon glyphicon-adjust" ></span> Khóa tài khoản
            </button>
        </div>
    </div>
<!--    <div id="form_form">   
